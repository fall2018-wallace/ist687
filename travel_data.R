...
#summary(modelOfFD)
lmAll <- lm(formula=Satisfaction~Age+Price.Sensitivity+Year.of.First.Flight+No.of.Flights.p.a.+No..of.other.Loyalty.Cards+Airline.Status+Type.of.Travel+Class+Scheduled.Departure.Hour+Arrival.Delay.greater.5.Mins, data = traveldatacleaned)
summary(lmAll)
